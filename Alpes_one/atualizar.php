...
<head>
    ...
    <title> Aualizar - Alpes One</title>
...
<form class="col-md-7 mt-3 rounded" action="conectabd.php" method="post" id="Formulario">
                <div class="center">
                    <div class="form-row">
                        <div class="col-md-6 col-sm-3 mb-3">
                            <p>Informe o Login seguido dos dados que deseja alterar </p>
        ...
        <div class="form-row ">
                ...
                <div class="form-row content-fluid">
                    ...
                    <button class="btn cor align-text-bottom mb-5" name='Alterar_Cadastro' type="submit"> Cadastrar Usuario </button>
